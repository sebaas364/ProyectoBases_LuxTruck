...
public class TrabajadorController {
	...
	public ResponseEntity<String> create(@RequestParam String numeroDocumento, @RequestParam String tipoDocumento,
		...
		TrabajadorDTO nuevoTrabajador = new TrabajadorDTO(null, numeroDocumento, tipoDocumento, primerNombre,
				segundoNombre, primerApellido, segundoApellido, telefono, correo, new Date(), salario, estadoNombre,
				contrasenia, estadoDTO);
